            ...
            <div className='about'>
                ...
                <div className='search'>
                    <Input placeholder="请输入电影名"
                        ...
                        append={<Button onClick={this.searchValue} type="primary" icon="search">搜索</Button>} />
                        ...
                        list.map((item, index) => {
                            return (
                                <li key={index}>
                                    ...
                                    <p><span className='span1'>{item.title}</span><span className='span2'>{item.rating.average}</span></p>
                                </li>
                            )
                        })
                    }
